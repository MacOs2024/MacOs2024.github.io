...
Остаточная неопределённость: дословный текст постоянной ревизии
`oldid=29521` не прочитан — исходящие запросы к домену из окружения
заблокированы. Всё, что индексируется поиском, указывает на ту же фразу про
2–3 глубины забивки. До ручной сверки страница цитирует плавающую ссылку,
которая заведомо ведёт на нужный документ.
